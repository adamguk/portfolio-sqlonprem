...
GRANT EXECUTE ON SCHEMA::MRT TO etl_serviceaccount;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHEMA::STG TO etl_serviceaccount;
GRANT SELECT ON SCHEMA::INT TO etl_serviceaccount;
GRANT SELECT, INSERT, UPDATE, DELETE ON SCHEMA::MRT TO etl_serviceaccount;
GO
...
GRANT EXECUTE ON SCHEMA::MRT TO dataengineer;
GO
...
GRANT ALTER ON SCHEMA::INT TO junior_dataengineer;
GO

--Analysts just access to marts
GRANT SELECT ON SCHEMA::MRT TO bianalyst;
GO
